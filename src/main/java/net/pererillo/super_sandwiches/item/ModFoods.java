...
public class ModFoods {
    ...
    public static final FoodProperties SUPER_PORK_SANDWICH = (new FoodProperties.Builder()).nutrition(14).saturationMod(1.2F).effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1200, 0), 1.0F).alwaysEat().meat().build();
    ...
    public static final FoodProperties SUPER_BEEF_SANDWICH = (new FoodProperties.Builder()).nutrition(14).saturationMod(1.2F).effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1200, 0), 1.0F).alwaysEat().meat().build();
    ...
    public static final FoodProperties SUPER_TERIYAKI_SANDWICH = (new FoodProperties.Builder()).nutrition(12).saturationMod(1.2F).effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1200, 0), 1.0F).effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE,600,0), 1.0F).alwaysEat().meat().build();
    ...
    public static final FoodProperties SUPER_GOLEM_SANDWICH = (new FoodProperties.Builder()).nutrition(8).saturationMod(1.2F).effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 1200, 1), 1.0F).alwaysEat().meat().build();
    ...
    public static final FoodProperties SUPER_TRAVELER_SANDWICH = (new FoodProperties.Builder()).nutrition(10).saturationMod(1.2F).effect(new MobEffectInstance(MobEffects.JUMP, 3600, 2), 1.0F).effect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 3600, 6), 1.0F).alwaysEat().meat().build();
    ...
    public static final FoodProperties FLAVORED_PHANTOM_MEMBRANE = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.6F).effect(new MobEffectInstance(MobEffects.LEVITATION,150,1),1.0F).meat().build();
    public static final FoodProperties SUPER_EXPLORER_SANDWICH = (new FoodProperties.Builder()).nutrition(10).saturationMod(1.2F).effect(new MobEffectInstance(MobEffects.JUMP, 2400, 50), 1.0F).effect(new MobEffectInstance(MobEffects.SLOW_FALLING, 2400, 1), 1.0F).alwaysEat().meat().build();
