...
public class ModFoods {
    ...
    public static final FoodProperties SUPER_TRAVELER_SANDWICH = (new FoodProperties.Builder()).nutrition(10).saturationModifier(1.2F).effect(new MobEffectInstance(MobEffects.JUMP, 3600, 2), 1.0F).effect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 3600, 6), 1.0F).alwaysEdible().build();
    ...
    public static final FoodProperties SUPER_EXPLORER_SANDWICH = (new FoodProperties.Builder()).nutrition(10).saturationModifier(1.2F).effect(new MobEffectInstance(MobEffects.JUMP, 2400, 50), 1.0F).effect(new MobEffectInstance(MobEffects.SLOW_FALLING, 2400, 1), 1.0F).alwaysEdible().build();
